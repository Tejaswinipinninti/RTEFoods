  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'orange': '0 10px 40px -10px rgba(255, 107, 0, 0.3)',
        'orange-lg': '0 20px 60px -15px rgba(255, 107, 0, 0.4)',
      },
      backgroundImage: {
        'gradient-primary': 'linear-gradient(135deg, #FF6B00 0%, #FF8C38 100%)',
        ...
        'gradient-premium': 'linear-gradient(135deg, #FF6B00 0%, #16A34A 100%)',
      },
      animation: {
